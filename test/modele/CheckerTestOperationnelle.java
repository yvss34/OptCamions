...
public class CheckerTestOperationnelle {
    ...
    @Test
    public void testContratDeTravailDuree1() {
        //ARRANGE
        Checker checker = new Checker(solution);

        ContratDeTravail contratDeTravail = new ContratDeTravail(15.0, 15.5, 100.0);

        for (int i = 0; i < solution.getChauffeurs().size(); i++) {
            solution.getChauffeurs().get(i).setContratDeTravail(contratDeTravail);

        }
        // ACT
        boolean resultat = checker.tempsContratTravail();
    ...
    @Test
    public void testContratDeTravailDuree2() {
        //ARRANGE
        Checker checker = new Checker(solution);
        ...
        solution.getChauffeurs().get(0).getContratDeTravail().setNbrHeureJour(50);
        // ACT
        boolean resultat = checker.tempsContratTravail();
    ...
    @Test
    public void testTrajetsPauses1() {
        //ARRANGE
        Checker checker = new Checker(solution);

        // ACT
        boolean resultat = checker.trajetsPause();
    ...
    @Test
    public void testTrajetsPauses2() {
        //ARRANGE
        Checker checker = new Checker(solution);
        TrajetFixe trajet1 = new TrajetFixe(256, new Ville(1, "Paris"), new Ville(4, "Luxembourg"), 24.0, new ArrayList<Double>(), null, new Jour(4, "Jeudi"), LocalTime.of(20, 0));
        solution.getTrajets().add(trajet1);
    ...
    @Test
    public void testTempsTrajets1() {
        //ARRANGE
        Checker checker = new Checker(solution);

        TrajetFixe trajet1 = new TrajetFixe(256, new Ville(1, "Paris"), new Ville(4, "Luxembourg"), 9.0, new ArrayList<Double>(), null, new Jour(4, "Jeudi"), LocalTime.of(8, 0));
        solution.getTrajets().add(trajet1);

        // ACT
        boolean resultat = checker.tempsTrajets();
    ...
    @Test
    public void testTempsTrajets2() {
        //ARRANGE
        Checker checker = new Checker(solution);

        TrajetFixe trajet1 = new TrajetFixe(256, new Ville(1, "Paris"), new Ville(4, "Luxembourg"), 9.1, new ArrayList<Double>(), null, new Jour(4, "Jeudi"), LocalTime.of(8, 0));
        solution.getTrajets().add(trajet1);
    ...
    @Test
    public void testTempsTrajets4() {
        //ARRANGE
        Checker checker = new Checker(solution);
        TrajetFixe trajet1 = new TrajetFixe(256, new Ville(1, "Paris"), new Ville(4, "Luxembourg"), 9.0, new ArrayList<Double>(), null, new Jour(4, "Jeudi"), LocalTime.of(21, 0));
        solution.getTrajets().add(trajet1);
        // ACT
        boolean resultat = checker.tempsTrajets();
    ...
    @Test
    public void testTempsTrajets5() {
        //ARRANGE
        Checker checker = new Checker(solution);
        TrajetFixe trajet1 = new TrajetFixe(256, new Ville(1, "Paris"), new Ville(4, "Luxembourg"), 8.0, new ArrayList<Double>(), null, new Jour(4, "Jeudi"), LocalTime.of(21, 0));
        solution.getTrajets().add(trajet1);
        // ACT
        boolean resultat = checker.tempsTrajets();
